...
| `.aigent/history/YYYY-MM-DD.jsonl` | TUI conversation history (last 200 turns restored on open) |
...
| `config/default.toml` | Main config (all sections: `[agent]`, `[llm]`, `[memory]`, `[tools]`, `[safety]`, `[git]`, `[ui]`) |
